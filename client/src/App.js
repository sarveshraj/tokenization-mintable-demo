...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({loaded:true, tokenSaleAddress:MyTokenSale.networks[this.networkId].address}, this.updateTokens);
    } catch (error) {
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Total tokens supply: {this.state.totalTokens}</h2>
